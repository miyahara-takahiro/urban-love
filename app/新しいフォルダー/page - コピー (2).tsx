...
function buildMockResult(first: RankedType, second: RankedType, p1: number, p2: number, axis: AxisScores) {
  ...
  return `【第一印象】
あなたは最初から露骨に怖い人には見えません。むしろ落ち着いていて、ちゃんとしていて、少し近寄りがたいけど綺麗にまとまっている印象を持たれやすいです。ただ、それは入口の話です。今回の結果は ${first.name} ${p1}% × ${second.name} ${p2}%。表向きは静かでも、中身は普通よりずっと濃い。近づくほど安全そうには見えなくなるタイプです。
...
【恋愛するとこうなる】
恋愛になると、あなたはかなり分かりやすく二層構造です。最初は様子を見る。けれど刺さった相手には、返信の速さ、会話のトーン、前に言っていた小さな約束まで、思った以上に覚えています。好きなうちは深いし、優しいし、相手にちゃんと合わせることもできます。でも曖昧にされた瞬間から少し空気が変わる。笑っていても、内側では静かに記録が始まっている感じです。

【正直めんどくさい所】
正直めんどくさいのは、自分ではそこまで怖いことをしている自覚が薄いところです。確認したい、知りたい、見抜きたい、忘れたくない。その気持ちが自然すぎて、相手からすると『え、そこまで見てたの？』『まだ覚えてるの？』になりやすい。しかも怒鳴るより黙る方が怖いタイプなので、空気だけが重くなっていくことがあります。笑顔のままちょっと圧があるの、かなり怪談です。

【でもハマる理由】
それでもあなたが強いのは、薄く終わらないからです。${first.gift} 表面だけの会話で終わらず、相手の中にちゃんと爪痕を残す。怖いのに気になる。重いのに、なぜか切れない。軽く消費されない濃さがあるから、恋愛ではわりと危険なくらい印象に残ります。たぶんあなたは、優しいだけの人よりずっと、後を引く人です。`;
}
    ...
    return (
      <div style={styles.page}>
        <div style={styles.card}>
          ...
          <p style={styles.lead}>恋をすると、あなたの中にいる何かが少しだけ顔を出します。30の質問から、あなたの中に潜む2つの都市伝説タイプを探り、最後にその気配をひとつに混ぜて映し出します。</p>
